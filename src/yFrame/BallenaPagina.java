...
public class BallenaPagina extends javax.swing.JFrame {
            ...
            botonAsiento.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                     if (boletosSeleccionados < boletosDisponibles) {
                        ...
                        JOptionPane.showMessageDialog(BallenaPagina.this, "Ya ha seleccionado todos los asientos permitidos.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            });
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/balleChi.gif"))); // NOI18N
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 250, 50));
    ...
    private void PagarBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PagarBtnMouseClicked
          BallenaPagar principal = new BallenaPagar(asientosSeleccionados, boletosSeleccionados);
        dispose();
        principal.setVisible(true);
