...
public class PalomitasCompra extends javax.swing.JFrame {
    
    /**
     * Creates new form Principal
     */
    public PalomitasCompra() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(PopCorn, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 90, 250, 250));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalomitasCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalomitasCompra().setVisible(true);
            }
        });
    }
