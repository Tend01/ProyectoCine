 ...
 * @author angel
 */
public class RefrescoCompra extends javax.swing.JFrame {
    
    /**
     * Creates new form Principal
     */
    public RefrescoCompra() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RefrescoCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RefrescoCompra().setVisible(true);
            }
        });
    }
