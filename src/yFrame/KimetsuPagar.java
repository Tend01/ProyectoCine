 ...
 * @author angel
 */
public class KimetsuPagar extends javax.swing.JFrame {
     ...
     */
    public KimetsuPagar(ArrayList<Integer> asientosSeleccionados, int boletosSeleccionados) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/kimetsuChi.gif"))); // NOI18N
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, 120, 180));

        regresar.setBackground(new java.awt.Color(202, 151, 166));
        ...
        jPanel1.add(regresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 360, 120, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KimetsuPagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
