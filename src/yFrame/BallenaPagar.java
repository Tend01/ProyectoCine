 ...
 * @author angel
 */
public class BallenaPagar extends javax.swing.JFrame {
     ...
     */
    public BallenaPagar(ArrayList<Integer> asientosSeleccionados, int boletosSeleccionados) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/balleChi.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BallenaPagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
