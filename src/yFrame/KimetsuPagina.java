 ...
 * @author angel
 */
public class KimetsuPagina extends javax.swing.JFrame {
            ...
            botonAsiento.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                     if (boletosSeleccionados < boletosDisponibles) {
                        ...
                        JOptionPane.showMessageDialog(KimetsuPagina.this, "Ya ha seleccionado todos los asientos permitidos.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            });
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 370, 120, 30));
    ...
    private void PagarBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PagarBtnMouseClicked
          KimetsuPagar principal = new KimetsuPagar(asientosSeleccionados, boletosSeleccionados);
        dispose();
        principal.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KimetsuPagina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KimetsuPagina().setVisible(true);
            }
        });
    }
