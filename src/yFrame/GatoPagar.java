 ...
 * @author angel
 */
public class GatoPagar extends javax.swing.JFrame {
     ...
     */
    public GatoPagar(ArrayList<Integer> asientosSeleccionados, int boletosSeleccionados) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/gatoChi.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GatoPagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
