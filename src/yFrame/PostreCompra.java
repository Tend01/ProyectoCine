...
public class PostreCompra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(mufin, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 120, 250, 250));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostreCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostreCompra().setVisible(true);
            }
        });
    }
